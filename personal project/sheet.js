...
const LINEAGE_LORE = {
  ...
  "Skittari": "The Skittari are bipedal spider-folk - primitive in the sense that their culture is oral, decentralized, and largely pre-agricultural, not in the sense of being simple. They are older than most of the cultures that would call them primitive, and their memory of the world's early shape is carried in stories that scholars have been trying to transcribe for a hundred years with limited success. Skittari anatomy is immediately arresting. They have three pairs of arms: two pairs in the normal humanoid configuration with hands at the ends, and one pair that juts from just below the shoulder blades, ending not in hands but in tapered chitinous points used for climbing and combat. Their faces have eight eyes arranged in two vertical rows along the sides of the skull - the upper four larger, the lower four smaller - with a wide, angular mouth positioned at roughly mid-face. Their skin is covered in fine dark bristle-hairs and their coloration varies from near-black to dark amber to a grey-brown that makes them nearly invisible in shadow.",
